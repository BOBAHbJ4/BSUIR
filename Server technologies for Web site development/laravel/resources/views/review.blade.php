...
@section('content')
    <div class="container">
           <div class="img-container"><img src="assets/icons/review_logo.png" alt="section_review_img"></div>
            <div class="col-md-8">
                <div class="card">
